...
SUB_PATH = os.environ.get('SUB_PATH', 'sub999')       # 获取订阅节点的token
UUID = os.environ.get('UUID', 'f5beacee-3f20-402c-8030-a7f3c2a1a5dc') # 节点和哪吒v1使用的UUID，默认固定值，建议自行生成一个唯一的UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nazha.xccssaa.dpdns.org:443') # 哪吒面板域名,v1格式: nezha.xxx.com:8008  v0格式：nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')     # 哪吒v0的agnet端口，v1请留空
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'EsGSPZ2kMIui9yfuvmQuzS7YSuIf6yrh')       # 哪吒v1的NZ_CLIENT_SECRET的值，v0请的agent密钥
ARGO_PORT = int(os.environ.get('ARGO_PORT', '8001')) # 隧道端口,使用固定隧道token时需要在cloudflare里设置和这里一致
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'vercel.xchwwss.dpdns.org')  # 固定隧道域名，留空将使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiMjBhN2JkMTA3ZTZhNzk1YTM3Zjk1ZTYxZTYyMTA3MDkiLCJ0IjoiM2ZhMDE2Y2ItY2RiMy00YmM4LWJkMGMtODRkYTBmZmRmYzY1IiwicyI6IllXSTNPV0l6TVRFdE1HTTBOUzAwWkRCbUxXSXhabUV0Wm1NeVptVmhZV0kyWVdFMyJ9')      # 固定密钥token或json，留空将使用临时隧道
...
CHAT_ID = os.environ.get('CHAT_ID', '7886284400')         # Telegram机器人ID，例如1001234567890
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7669258945:AAGNTd8625Oy6h3oWN8en1EfDn2ZY0BjpHc')     # Telegram机器人Token，例如123456:ABC-DEF1234ghIkl-zyx57W2v1u123ew11
